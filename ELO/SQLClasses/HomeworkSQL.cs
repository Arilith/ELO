    ...
    public class HomeworkSQL
    {
        ...
        public List<Homework> GetHomeWorkList(string school)
        {
            ...
            while (homeworkReader.Read())
            {
                ...
                returnList.Add(new Homework(returnTitle, insertSubject, returnContent, returnDate, insertClass, returnExp, isTest, forGrade));
            }
        ...
        public Homework GetHomeworkFromDatabase(string homeworkUUID)
        {
            ...
            if (homeworkReader.Read())
            {
                ...
                return new Homework(returnTitle, insertSubject, returnContent, returnDate, insertClass, returnExp, isTest, forGrade);
            }
            homeworkReader.Close();

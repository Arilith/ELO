...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form method="post" id="form1" enctype="multipart/form-data" action="UploadFile.aspx">
        ...
        <input type="file" class="form-control" name="uploadedFile" required id="uploadedFile" runat="server" /><br/><br/>
        <asp:button CssClass="btn btn-primary" id="btnUpload" type="submit" text="Upload" runat="server" OnClick="btnUpload_Click"/><asp:button />

<%@ Page Title="Puntenseizoen" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BattlePass.aspx.cs" Inherits="Front_End.BattlePass" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<%@ Import Namespace="System.Globalization" %>
<%@ Import Namespace="ELO" %>
    <meta name="viewport" content="width=device-width, initial-scale=1" />

<h2 draggable="auto">Puntenseizoen</h2>
<style>
    td {
        padding: 10px;
    }

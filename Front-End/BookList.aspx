...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %></h2>
    <h2><asp:TextBox ID="TextBoxTitle" runat="server" Height="28px" BackColor="#666666" style="margin-right: 7px" Width="218px"></asp:TextBox>
        <asp:Button ID="ButtonAddBook" runat="server" OnClick="Button1_Click" Text="Add New" Height="35px" Width="131px" BackColor="#666666" ForeColor="White" />
    </h2>

...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form method="post" id="form1" enctype="multipart/form-data" action="UploadFile.aspx">
        Op deze pagina is het mogelijk om een CSV bestand te uploaden om meerdere leerlingen in een keer toe te voegen. <br/> Helaas is deze functionaliteit op dit moment nog niet beschikbaar. 
